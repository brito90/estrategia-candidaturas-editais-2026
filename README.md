# 🌟 ESTRATÉGIA DE CANDIDATURAS - EDITAIS 2026
...
**Responsabilidade:** Kauan Santiago (Visão Cultural)

---

## PROJETOS CRIADOS

### 1. 🌱 Fossa Ecológica - Tanque de Evapotranspiração
- **Orçamento:** R$ 137.500
- **Foco:** Saneamento ecológico, tecnologia social
- **Duração:** 12 meses
- **Rep:** github.com/brito90/fossa-ecologica-evapotranspiracao

### 2. 🐳 Terreiros Sustentável
- **Orçamento:** R$ 125.500
- **Foco:** Compostagem, gestão de resíduos, agroecologia, educação
- **Duração:** 12 meses
- **Rep:** github.com/brito90/terreiros-sustentavel

### 3. 📚 Biblioteca Ojisé
- **Orçamento:** R$ 114.500
- **Foco:** Memória, leitura, combate ao racismo religioso
- **Duração:** 12 meses
- **Rep:** github.com/brito90/biblioteca-ojise

---

## EDITAIS MAPEADOS (8 PRINCIPAIS)

### CATEGORIA 1: SANEAMENTO E TECNOLOGIA SOCIAL

| Edital | Valor | Prazo | Status | Projeto |
|--------|-------|-------|--------|----------|
| **Prêmio Bahia Sustentável 2026** | Prêmio (sem monétario direto) | 02/03/2026 | ✅ ABERTO | Fossa + Terreiros |
| EMENDAS Eco-coletivo | até R$ 50k | Aberto | ✅ ABERTO | Fossa |
| Acelen Incentiva | até US$ 10k | Contínuo | ✅ ABERTO | Terreiros |

### CATEGORIA 2: COMUNIDADES TRADICIONAIS

| Edital | Valor | Prazo | Status | Projeto |
|--------|-------|-------|--------|----------|
| **CAR Quilombos + Indígenas** | R$ 24M (total) | 11/02/2026 | ✅ ABERTO | Terreiros (se co-executor quilombola) |
| Banco da Amazônia | R$ 3,9M | 28/11/2025 | ❌ VENCIDO | N/A |

### CATEGORIA 3: CULTURA E BIBLIOTECA

| Edital | Valor | Prazo | Status | Projeto |
|--------|-------|-------|--------|----------|
| **Statkraft - Lei Incentivo** | até R$ 80k | Aberto | ✅ ABERTO | Biblioteca |
| **PNLD Literário Equidade** | Distribuição de livros | 2026-2029 | ✅ ABERTO | Biblioteca |
| Casa Sueli Carneiro - Grupos Leitura | 50 grupos | Aberto | ✅ ABERTO | Biblioteca |
| PNAB Cultura Viva | R$ 9M (RS) | Aberto | ✅ ABERTO | Biblioteca (como Ponto Cultura) |

### CATEGORIA 4: DIREITOS HUMANOS E RACISMO

| Edital | Valor | Prazo | Status | Projeto |
|--------|-------|-------|--------|----------|
| **Fundo Brasil 2026** | R$ 1M (20 orgs, até R$ 50k) | 06/03/2026 | ✅ ABERTO | Biblioteca + Terreiros |
| CGMET (Min DH - Memória Negra) | até R$ 100k | Aberto | ✅ ABERTO | Biblioteca |
| Min Igualdade Racial - Caminhos AmeFr | 150 vagas | Aberto | ✅ ABERTO | Capacitação (Biblioteca) |

---

## CENÁRIOS DE CANDIDATURA

### 🟢 CENÁRIO CONSERVADOR (Próximos 90 dias)

**JANEIRO 2026 (já é!):**
- [ ] Finali Biblioteca Ojisé README (✅ PRONTO)
- [ ] Submeter proposta STATKRAFT (Lei Incentivo) - prazo flexível

**FEVEREIRO 2026:**
- [ ] Preparar e submeter Edital CAR (Quilombos/Indígenas) - **Prazo: 11/02**
- [ ] Enviar Prêmio Bahia Sustentável (Tecnologia Social) - **Prazo: 02/03**

**MARÇO 2026:**
- [ ] Submeter Fundo Brasil (Direitos Humanos) - **Prazo: 06/03**
- [ ] Encaminhar EMENDAS Eco-coletivo

**Resultado Esperado Conservador:**
- 3-4 candidaturas ativas
- Potencial: R$ 130-200k + livros (PNLD) + prêmio reconhecimento

### 🟠 CENÁRIO INTERMEDIÁRIO (Projectos Integrados)

Criar "Megaprojeto Guarda-Chuva":
**"Complexo de Memória, Sustentabilidade e Ancestralidade dos Terreiros"**

- Integrar 3 projetos como 1 iniciativa estratégica
- Reposicionar para:
  - Funo Brasil (Megaprojeto: R$ 50k)
  - Prêmio Bahia (2 categorias: Tecnologia Social + Comunidade)
  - CGMET + Statkraft (componente cultural)

**Potencial Intermediário:** R$ 200-250k

### 🔴 CENÁRIO AGRESSIVO (Máximo Impacto)

Candidaturas simultâneas a TODOS 8 editais:
- Fundo Brasil (R$ 50k) ✅
- Statkraft (R$ 80k) ✅
- Prêmio Bahia (Prêmio + Reconhecimento) ✅
- CAR Quilombos (se qualificado: até R$ 800k) ✅
- PNLD (Distribuição de livros) ✅
- CGMET (até R$ 100k publicação) ✅
- EMENDAS (até R$ 50k) ✅

**Potencial Agressivo:** R$ 280-350k + distribuição de 500+ livros

---

## PLANO DE AÇÃO (13 SEMANAS)

### SEMANA 1 (22-28 Jan 2026) - ESTE MOMENTO
✅ Criar 4 repositórios GitHub
✅ Documentar 3 projetos (Fossa + Terreiros + Biblioteca)
✅ Mapear 8 editais principais
- [ ] Preparar PITCH CURTO para Statkraft (1 página)
- [ ] Listar contatos parceiros (museu, terreiros, universidades)

### SEMANAS 2-3 (29 Jan - 11 Fev 2026) - CORRIDA CAR
- [ ] Estruturar manifestação de interesse para CAR Quilombos/Indígenas
- [ ] Confirmar s e terreiro é organiza\u00e7ão quilombola ou indígena
- [ ] Submeter CAR (Prazo: 11 Fev) - **CRÍTICO**

### SEMANAS 4-5 (12-26 Fev 2026) - PRÊMIO BAHIA
- [ ] Preparar proposta com evidências de projeto
- [ ] Fotografias, cronograma, cronograma financeiro
- [ ] Submeter Prêmio Bahia Sustentável (Prazo: 02 Mar) - **CRÍTICO**

### SEMANAS 6-7 (27 Fev - 12 Mar 2026) - FUNDO BRASIL
- [ ] Redigir proposta institucional para Fundo Brasil
- [ ] Ênfase: Povos Tradicionais + Equidade Racial
- [ ] Submeter Fundo Brasil (Prazo: 06 Mar) - **CRÍTICO**
- [ ] Submeter EMENDAS Eco-coletivo (paralelo)

### SEMANAS 8-13 (13 Mar+) - COMPLEMENTARES
- [ ] Formalizar com Statkraft (Lei Incentivo)
- [ ] Iniciar diálogos com CGMET (Memória)
- [ ] Explorar PNLD e Ponto Cultura

---

## PONTOS-CHAVE DE SUCESSO

1. **Identificar Parceiro Executor Local**
   - Terreiro(s) de Candomblé específico
   - Se quilombola/indígena → CAR fecha (R$ 24M!)

2. **Documentação Impec ável**
   - GitHub: evidência de planejamento
   - CNPJ organização executor
   - Cartas de apoio (museu, universidade, comunidade)

3. **Priorize Prazos**
   - 11 Fev: CAR (\u00c9 CRÍTICO!)
   - 02 Mar: Prêmio Bahia
   - 06 Mar: Fundo Brasil

4. **Integração entre Projetos**
   - Fossa alimenta Terreiros
   - Terreiros alimenta Biblioteca (conhecimento agroecológico)
   - Biblioteca integrada com Museu Pai Procópio

---

## CONTATOS E LINKS

### EDITAIS LINK DIRETOS
- Prêmio Bahia: ba.gov.br/meioambiente
- CAR Quilombos: data.car.ba.gov.br/smi (Prazo: 12 Jan - 11 Fev)
- Fundo Brasil: fundobrasil.org.br (Prazo: até 06 Mar)
- Statkraft: statkraft.com.br/sustentabilidade (Aberto)

### ORGANIZAÇÕES-CHAVE
- Terreiro Pai Procópio de Ogun já
- Museu Pai Procópio
- UFBA, UNILAB, UESC (parcerias acadêmicas)
- Movimento Negro Ba
- ONG Direitos Humanos local

---

## PRÓXIMOS PASSOS (IMEDIATO)

✅ GitHub 4 repos + documentação ✅
🔄 ESTA SEMANA:
1. Definir terreiro parceiro (e se é quilombola)
2. Encaminhar STATKRAFT (Lei Incentivo)
3. Confirmar disponibilidade museu e universidades

**Coordenador:** Kauan Silva  
**E-mail:** brito90@github.com  
